...
/**
 * HotKeyConfigurationSelector 负责根据配置选择是否导入 hotkey 相关配置，
 * 包括实例 BeanRegistrar 和自动装配配置。
 *
 * 当 hotkey 未开启时，不会向容器中注册任何相关 Bean。
 *
 * @author ispengya
 */
public class HotKeyConfigurationSelector implements DeferredImportSelector, Ordered, EnvironmentAware {
    ...
    public String[] selectImports(AnnotationMetadata importingClassMetadata) {
        ...
        HotKeyProperties properties = binder.bind("hotkey", Bindable.of(HotKeyProperties.class))
